...
batch_iou_loss_jit = torch.jit.script(
    batch_iou_loss
)
...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_object: float = 1, cost_iou: float = 1, cost_mask: float = 1, cost_dice: float = 1, num_points: int = 0):
        """Creates the matcher
        ...
        assert cost_object != 0 or cost_iou != 0 or cost_mask != 0 or cost_dice != 0, "all costs cant be 0"
    ...
    def memory_efficient_forward(self, outputs, targets):
        ...
        for b in range(bs):
            ...
            cost_object =-out_object_prob[:,tgt_ids]
            ...
            with autocast(enabled=False):
                ...
                if out_mask.shape[0] == 0 or tgt_mask.shape[0] == 0:
                    ...
                    # cost_iou=batch_iou_loss(out_mask, tgt_mask)
                    ...
                    # cost_iou=batch_iou_loss_jit(out_mask, tgt_mask)
