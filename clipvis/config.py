...
def add_clipvis_config(cfg):
    """
    Add config for clipvis.
    """
    # data config
    ...
    cfg.MODEL.MASK_FORMER.MASKIOU_WEIGHT = 1.0
    ...
    cfg.MODEL.MASK_FORMER.IMPORTANCE_SAMPLE_RATIO = 0.75
     #inference
    cfg.TEST.TEST_NUM_CLASSES = 1203
    cfg.TEST.NUM_FRAME= 9
    cfg.TEST.NUM_TOPK= 5 
    cfg.TEST.WINDOW_INFERENCE = False
